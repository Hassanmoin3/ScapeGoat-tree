                          ######################SCAPEGOAT TREE#######################
*******INTRODUCTION:******* 
scapegoat tree is an implemetation of self balancing tree . This structure is based on a common wisdom that when something goes wrong the first thing people tend to do is to blame someone known as scapegoat here we blame a node that is responsible for unbalance of the tree and than the scapegoat node fix that problem by rebuilding it self.
...
than the 3rd option is to search any element of the tree than the 4th option is pre-order , the 5th option is post-order and the last 6th option is in-order.

***********PRESENTED BY:**********

      FALAK NAZ    17B-020-SE(A)

      HASSAN MOIN    17B-03-SE(A)
